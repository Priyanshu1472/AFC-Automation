// Mirrors supabase/functions/_shared/empanelmentFields.ts — the canonical
// list of fields/documents a reviewer can raise a compliance flag against.
export const FLAGGABLE_TEXT_FIELDS = {
...
export const FLAGGABLE_DOCUMENT_SLOTS = {
...
export function labelForFieldKey(fieldKey) {
