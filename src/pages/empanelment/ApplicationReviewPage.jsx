...
function TimelineAccordion({ logs }) {
          ...
          <div key={log.id} className={`ar-acc-item${isOpen ? " ar-acc-item-open" : ""}`}>
            <button className="ar-acc-header" onClick={() => setOpenId(isOpen ? null : log.id)} aria-expanded={isOpen}>
              ...
              <div className="ar-acc-meta">
                <span className="ar-acc-name">{log.actor?.full_name || "Business Associate"}<span className="ar-acc-role"> ({ROLE_LABELS[log.actor_role] || log.actor_role})</span></span>
